...
export default function SignUp() {
  ...
  const [renterState, setRenterState] = useState({
    username:"",
    email: "",
    password: "",
    name: "",
  ...
  const submitForm = async () => {
    setLoading(true);
    console.log("The payload is", renterState);
    axios
      .post("/api/auth/renter/signup", renterState)
      .then((res) => {
        setLoading(false);
        console.log("The response is", res.data);
        const response = res.data;
        if (response.status == 200) {
          router.push(`/renter-login?message=${response.msg}`);
              ...
              <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="username"
                      onChange={(e) =>
                        setRenterState({ ...renterState, username: e.target.value })
                      }
                    ></input>
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="name"
                      onChange={(e) =>
                        setRenterState({ ...renterState, name: e.target.value })
                      }
                    ></input>
                    <span className="text-red-500 font-bold">
                      {errors?.name}
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="email"
                      onChange={(e) =>
                        setRenterState({ ...renterState, email: e.target.value })
                      }
                    ></input>
                    <span className="text-red-500 font-bold">
                      {errors?.email}
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      id="password"
                      onChange={(e) =>
                        setRenterState({ ...renterState, password: e.target.value })
                      }
                    ></input>
                    <span className="text-red-500 font-bold">
                      {errors?.password}
